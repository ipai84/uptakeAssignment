...
public class CommonPageComponentsHeader {
	...
	public boolean checkAllHeaderElemnts(String page) {
		...
		if (CompositeUIElement.checkifElementPresent(HEADER_UPTAKE_LOGO,
				"Uptake Logo was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_APPROACH_LINK,
				"Approach link was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_PLATFORM_LINK,
				"Platform link was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_SOLUTIONS_LINK,
				"Solutions link was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_PEOPLE_LINK,
				"People link was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_JOINUS_LINK,
				"Join Us link was not found in header in page : " + page) == false)
			isTestCasePassed = false;

		if (CompositeUIElement.checkifElementPresent(HEADER_BLOG_LINK, "Blog link was not found in header in page : "
				+ page) == false)
			isTestCasePassed = false;
		...
		if (CompositeUIElement.checkifElementPresent(HEADER_TOP,
			...
			if (driver.findElement(HEADER_TOP).getAttribute("class")
